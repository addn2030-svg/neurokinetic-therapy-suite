...
insert into agent_state (key, value) values
  ('weekly_spending_cap', '{"cap_sar": null, "note": "حدد قيمة السقف يدوياً — القيمة المالية محذوفة"}'),
...
insert into tasks (id, title, domain, importance, urgency, project, status, next_action, risk, due_date, source) values
  ('T-FIN-FILES',   'استكمال الملفات المالية',                          'مهني',               'عالي',   'عالي',   'خطة التعافي المالي',   'in_progress', 'تحديد الخطوة الأولى لضبط الموازنة',              'حرج (مرتبط بالموازنة)',        '2026-09-05', 'خطة الإنجاز والمهام'),
  ...
  ('T-SAVE',        'تفعيل جانب الادخار',                               'شخصي',               'عالي',   'متوسط',  'الأصول والادخار',    'in_progress', 'تحديد مبلغ مستهدف شهري للاقتطاع',               'مرتفع (مرتبط بالموازنة)',      '2026-09-08', 'خطة الإنجاز والمهام'),
  ...
  ('FIN-001',       'الالتزام بسقف الإنفاق الأسبوعي',                   'مالي',               'عالي',   'عالي',   'خطة التعافي المالي', 'in_progress', 'متابعة مصاريف المعيشة اليومية دون تجاوز',      'حرج (مرتبط بالموازنة)',        '2026-09-07', 'التحليل المالي المختصر'),
